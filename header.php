...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>PID</strong> Realty</a></h1>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <?php //39.. Finish Program Menu Item Link ?>
            <li <?php if (get_post_type() == 'program') echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('program') ?>">Programs</a></li>
            <?php //32. Quick Timeout: Make Event Link Responsive ?>
            ...
            <li <?php if (get_post_type() == 'community' ) echo 'class="current-menu-item"';  ?>>
              <a href="<?php echo get_post_type_archive_link('community'); ?>">Communities</a></li>
