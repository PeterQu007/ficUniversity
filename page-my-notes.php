...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
      <div class="create-note">
        ...
        <span class="note-limit-message">Note Limit reached: delete an old one</span>
      </div>
        ...
        <?php 
          ...
          while($userNotes->have_posts()) {
            ...
            <li data-id="<?php the_ID() ?>">
              ...
              <textarea readonly class="note-body-field"><?php echo sanitize_textarea_field((get_the_content())); ?></textarea>
